...
Axiom LoopInvariant1 : is_index k s.
...
Parameter lplbrbrp'result'unused'unused: pt.

Parameter ccw'result'unused'unused: Init.Datatypes.bool.

Axiom H3 : (k = i).

Axiom H4 : ~ (Init.Datatypes.false = Init.Datatypes.true).
...
(* Why3 goal *)
Theorem check_all_on_left'vc : is_index (k + 1%Z)%Z s.
Proof.
